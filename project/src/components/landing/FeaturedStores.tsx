...
const mockStores = [
  {
    ...
    slogan: "La mode à portée de main",
    visitCount: 1234,
    products: [
      { id: 1, name: "Robe élégante", price: 25000, images: ["https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?w=100"] },
      { id: 2, name: "Chaussures tendance", price: 35000, images: ["https://images.unsplash.com/photo-1549298916-b41d501d3772?w=100"] },
      { id: 3, name: "Sac à main", price: 15000, images: ["https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=100"] }
    ]
  },
  {
    id: 2,
    ...
    slogan: "L'innovation à votre service",
    visitCount: 2156,
    products: [
      { id: 4, name: "Formation Web", price: 50000, images: ["https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=100"] },
      { id: 5, name: "E-book Marketing", price: 12000, images: ["https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=100"] },
      { id: 6, name: "Template Site", price: 8000, images: ["https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=100"] }
    ]
  }
];
...
const FeaturedStores = () => {
  ...
  const filteredStores = mockStores.filter(store => store.type === activeTab);
  ...
  const handleStoreVisit = (slug) => {
    // Simuler la navigation vers la boutique
    console.log(`Navigation vers /store/${slug}`);
  ...
  const handleCreateStore = () => {
    // Simuler la navigation vers la création de boutique
